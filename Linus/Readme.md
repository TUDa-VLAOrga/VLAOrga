...
3. Then, create a file .env.local in the datenbank-physik repo with content
        ...
        DATABASE_URL=mysql://db_user:db_password@linus-db:3306/db_name?serverVersion=5.7&charset=utf8mb4
...
5. To be able to log in for testing, insert a dummy user (its password is `Füsik!`) into the database by hand:
        ...
        VLAOrga/Linus $ cat testdata.sql | docker compose exec -T linus-db mysql db_name --user=db_user --password=db_password
