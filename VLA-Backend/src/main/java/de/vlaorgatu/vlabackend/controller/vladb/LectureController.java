...
public class LectureController
        ...
        if (Objects.nonNull(lecture.getId())) {
            if (lecture.getId() < 0) {
                ...
                throw new InvalidParameterException(
                    "Received lecture with ID " + lecture.getId() +
                        " when creating a new lecture.");
            }
        }

        Lecture savedLecture = lectureRepository.save(lecture);
        SseController.notifyAllOfObject(SseMessageType.LECTURECREATED, savedLecture);
    ...
    public ResponseEntity<Lecture> deleteLecture(@PathVariable Long id) {
        ...
        SseController.notifyAllOfObject(SseMessageType.LECTUREDELETED, deletedLecture);
