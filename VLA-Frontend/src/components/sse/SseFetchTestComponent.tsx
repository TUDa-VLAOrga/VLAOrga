...
export default function SseFetchTestComponent(){
  ...
  const debugMessage = useSseConnectionWithInitialFetch<{message: string}>({message: "You won't see this secret message, when I am around with my friend backend, I do not know what to say without him.."}, "/sse/getTestData", eventHandlers);
